						...
						<div class="widget-wrap">
							...
							<div class="cause-info-widget">
								...
								<div class="cause-info-widget-donated">
									<span><?php echo $dd_donation_currency . $donation_current; ?></span>
								...
								<?php if ( $show_donation_bar ) : ?>
									...
									<div class="cause-info-widget-percentage">
										<span><?php echo $donation_percentage; ?>%</span> <?php _e( 'raised of', 'dd_string' ); ?> <span><?php echo $dd_donation_currency . $donation_goal; ?></span> <?php _e( 'goal', 'dd_string' ); ?>
