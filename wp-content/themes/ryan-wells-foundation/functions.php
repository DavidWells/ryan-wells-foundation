...
function dd_theme_scripts() {
	...
	if ( class_exists( 'woocommerce' ) ) {
		wp_enqueue_style( 'woocommerce', get_template_directory_uri() . '/css/woocommerce.css', array( 'woocommerce_frontend_styles' ) );
	}
		...
		if ( $dd_query->have_posts() ) : ?>
			...
			<div class="causes-wrapper home-section <?php echo $wrapper_class; ?>">
				...
				<div class="container">
					...
					<div class="causes carousel clearfix">
						...
						<div class="flexslider">
							...
							<ul class="slides">
								 ...
								 <?php while ( $dd_query->have_posts() ) : $dd_query->the_post();  ?>
									...
									<li class="cause <?php echo $post_width_class; ?> <?php echo $post_class_append; ?>">
						...
						<div class="flexslider">
							...
							<ul class="slides">
								 ...
								 <?php while ( $dd_query->have_posts() ) : $dd_query->the_post();  ?>
									...
									<li class="blog-post <?php echo $post_width_class; ?> <?php echo $post_class_append; ?>">
		...
		if ( $dd_query->have_posts() ) : ?>
			...
			<div class="staff-members-wrapper home-section <?php echo $wrapper_class; ?>">
				...
				<div class="container">
					...
					<div class="staff-members carousel clearfix">
						...
						<div class="flexslider">
							...
							<ul class="slides">
								 ...
								 <?php while ( $dd_query->have_posts() ) : $dd_query->the_post();  ?>
									...
									<li class="staff-member four columns <?php echo $post_class_append; ?>">
		...
		if ( $dd_query->have_posts() ) : $start_at = true; ?>
			...
			<div class="events-wrapper home-section <?php echo $wrapper_class; ?>">
				...
				<div class="container clearfix">
					...
					<div class="events carousel clearfix two-thirds column last">
		...
		if ( $dd_query->have_posts() ) : $start_at = true; ?>
			...
			<div class="events-no-cal-wrapper home-section <?php echo $wrapper_class; ?>">
				...
				<div class="container clearfix">
					...
					<div class="events carousel clearfix">
						...
						<div class="flexslider">
							...
							<ul class="slides">
								 ...
								 <?php $start_at = true; while ( $dd_query->have_posts() ) : $dd_query->the_post();  ?>
									...
									<li class="event <?php echo $post_width_class . $post_class_append . $start_at_class; ?>" data-day="<?php the_time( 'j m Y' ); ?>">
		...
		if ( $dd_query->have_posts() ) : ?>
			...
			<div class="sponsors-wrapper home-section <?php echo $wrapper_class; ?>">
				...
				<div class="container">
					...
					<div class="sponsors carousel clearfix">
						...
						<div class="flexslider">
							...
							<ul class="slides">
								 ...
								 <?php while ( $dd_query->have_posts() ) : $dd_query->the_post();  ?>
									...
									<li class="sponsor <?php echo $post_width_class; ?> <?php echo $post_class_append; ?>">
