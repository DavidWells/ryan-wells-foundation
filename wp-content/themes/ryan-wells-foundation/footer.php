		...
		<footer id="footer">
			...
			<?php if ( ot_get_option( $dd_sn . 'footer_banner', 'enabled' ) == 'enabled' ) : ?>
				...
				<div id="footer-banner" data-bg-image="<?php echo ot_get_option( $dd_sn . 'footer_banner_img', 'none' ); ?>">
					...
					<form action="//ryanwellsfoundation.us1.list-manage.com/subscribe/post?u=ce5d31e8b58fb8251cb227c29&amp;id=aebf7b685b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					    <div id="mc_embed_signup_scroll">

						<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Enter your email address" required>
					    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
					    <div style="position: absolute; left: -5000px;"><input type="text" name="b_ce5d31e8b58fb8251cb227c29_aebf7b685b" tabindex="-1" value=""></div>
					    <div class="clear"><input type="submit" value="Stay up to date" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
					    </div>
					</form>
					</div>
